...
import { MdReportProblem, MdConstruction } from "react-icons/md";
...
const portfolioData = [
  {
    ...
    description: "A high-conversion reservation system and digital menu for an upscale dining establishment.",
    stat: "+45% Bookings",
    year: "Launch 2024",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBJaTdPbLPvzABmtJDgyWAug0QceZVRFlqpIQiKURiZu1I3ZYI9lpdIX4P2gHLmo4ptGO6KEtbvCQn4kXkoSCuTroZkuwn_uSofO2ePeNt9zNgP6QvfiNy-0IhHSCq3O7_vZeLqvwoQdMcoTWFrbQO0Wu7ERDpuF3SXW6Qb_roAKRKGBdy-IOjxTTIRDqwJCOutaB9eoiRoAhGa5_5YmQEXcFabW_a8b3CUMgQVy-GctQ-xu4-QXMAt4RcX1SVLhTl_SkyH2yza4G0"
  },
  {
    title: "Apex Legal Partners",
    category: "Services",
    categoryColor: "bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400",
    description: "Corporate branding and lead generation platform for a boutique legal firm.",
    stat: "+60% Inquiries",
    year: "Launch 2023",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDEA8yj_GNgTjHvjePEK2PU0V3H5TESjMi5sqAbrGHyAsaPnoY5mMFLdyuMtxxpIRfDBpJkSxiSrVKQnJ89QMp2SZZag4HpIMdAj82UC_lmRv0v-SncE4knKXtgkxGB8zAsAydh5T0Vsj6AXRiqi7exNGnFEwwlged5T-TE1WepdoGJcde7TZMlOUdrfK05L4Lc7NJgRgb6g_i8lkdWzG2HjHiCiRpq_n8vrRE5Lwtj-NZZNg9_JCc83wuW56enDdi6MUf61rjA0dI"
  },
  {
    title: "Luna Boutique",
    category: "E-commerce",
    categoryColor: "bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400",
    description: "A seamless shopping experience for a handmade jewelry brand with Shopify integration.",
    stat: "+120% Sales",
    year: "Launch 2024",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCn_TpmwlCGHo_qEV2Xl7zXbtra52ch3lrX8VC2Nmad-FEDPimgSnKup7Ty11-aoz5ds5Ngwa12O0I_zLPib7nQ0DTDPHqGZ89OVbbXS0qA7YcoNxKB1e7ZvtuOdJGZSW6oO9BXDBNlzAevux-pk3RTedZRlJTyR_eUJDB-J1wluQfLF3Vxv_TGYtf2BW7vYHDQoZ7OElolVGtylzo8pZvYR2GU9Hz8lZurtfUBmb-lBKyy4p_7Z0RN_3o87Ew9XBLFmsrDWNMmsdg"
  },
  {
    title: "Core Strength Studio",
    category: "Landing Page",
    categoryColor: "bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400",
    description: "High-impact landing page designed to drive new membership signups.",
    stat: "+30% Leads",
    year: "Launch 2023",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAx-1m3YTjBPGWhKeeoeZuR4ggk2fV2zI_1dFpdxowCFPvnFQpkeA-v-IGXwsJCkeo75XPaK3D4yfBehcgYesY70tYyOTOoO0kEVFduv1-TfRqCVUtFklvt1yySiuvznYxMNqwOkdMTHAsQsKd5KyMLNtMcsKS_tA4WfDuJ2vlUSwqiUhVkko_-jZwzjR0bD_zuRXddhjqYCXjQYi3coj1Rh3LmBisrGTc_p8stMBdpwppm09NVtXuhj7601QYtEcM7-41VuyfdY18"
  },
  {
    title: "CloudOps Insight",
    category: "SaaS",
    categoryColor: "bg-cyan-100 dark:bg-cyan-900/30 text-cyan-600 dark:text-cyan-400",
    description: "Complex dashboard design and marketing site for a cloud infrastructure startup.",
    stat: "+25% Retention",
    year: "Launch 2024",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDHzBd85y4p4U3xXV55OE-SWLUI8FlYTkpjr04m6Gx8ZV_Cj091iRz_OtsQQtBhzWGXmMu7f1pVXbrW2M7eXZeZxTkCaU-QXsGp7GA_Big0Z0ZGSBwL7HRbQpH5bPYFFTQHtxJaxbBBPCrZsEQp3cxJhmjssIho9LYabU09_1z6iLYSd9ZvHQ-hyufIAYSeCfT6ezqEE5JoWTeevSZI1PTALAq2v4p9ShdOOONtmfIqVB3uFvc_OP8T5AmVZFxAbDgJoR1cojJtF1A"
  },
  {
    title: "Wellness & Health",
    category: "Booking",
    categoryColor: "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400",
    description: "Integrated patient portal and appointment scheduling for a local clinic.",
    stat: "+80% Efficiency",
    year: "Launch 2023",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuCL1BN4BfnkUlY7CdfLTpSpw-DKkSh-cuZDwF5WTP7ePwrpLP_zimt8FDpd3svR4gpYHtcVjjPqvPy17Z4vGOe3jn5taKfuIBN9SKKEXJSOSq88lSO7CGXj_MAKyagyQ8s_tkEK4MltBJbzctm_92e8YKFaSdljGTPNIlYzcOMITgFug_p_lwiWZQRgexOb4MPK6dF6iYKpPgcNrz3GhC02CLUbOVbPzXlNOumYQ5YUAXT0cvC1PwchBFvmK6_tTQe-uZCU8d8U4Lc"
  }
];
  return (
    <>
        ...
        <div className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              We've helped hundreds of small businesses transform their digital
              presence. Explore our curated portfolio of free custom builds and
...
<button className="filter-btn active px-6 py-2 rounded-full border border-slate-200 dark:border-slate-800 font-medium transition-all hover:border-accent">All Work</button>
<Link to="/e-commerce">
  <button className="filter-btn px-6 py-2 rounded-full border border-slate-200 
dark:border-slate-800 font-medium transition-all hover:border-accent">E-commerce</button>
</Link>
<Link to="/professional-services">
  <button className="filter-btn px-6 py-2 rounded-full border border-slate-200 dark:border-slate-800 font-medium transition-all hover:border-accent">Professional Services</button>
</Link>
<Link to="/booking-platforms">
  <button className="filter-btn px-6 py-2 rounded-full border border-slate-200 dark:border-slate-800 font-medium transition-all hover:border-accent">Booking Platforms</button>
</Link>
<Link to="/landing-pages">
  <button className="filter-btn px-6 py-2 rounded-full border border-slate-200 dark:border-slate-800 font-medium transition-all hover:border-accent">Landing Pages</button>
</Link>
</div>
</div>
...
<div className="px-6 pb-24">
  ...
  <div className="bg-white dark:bg-slate-900/50 py-24 px-6 border-y border-slate-100 dark:border-slate-800">
...
<div className="py-24 px-6 bg-slate-50 dark:bg-background-dark" id="contact">
  <div className="max-w-7xl mx-auto">
