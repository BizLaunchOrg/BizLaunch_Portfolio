import { MdCheckCircle, MdConstruction, MdFlashOn, MdReportProblem } from "react-icons/md";
      ...
      <div>
        ...
        <div className="pb-12 px-6">
          <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-3">
            <button className="filter-btn active px-6 py-2 rounded-full border border-slate-200 dark:border-slate-800 font-medium transition-all hover:border-accent">
              All Work
            </button>
            <Link to="/e-commerce">
              <button
                className="filter-btn px-6 py-2 rounded-full border border-slate-200 
dark:border-slate-800 font-medium transition-all hover:border-accent"
              >
                E-commerce
              </button>
            </Link>
            <Link to="/professional-services">
              <button className="filter-btn px-6 py-2 rounded-full border border-slate-200 dark:border-slate-800 font-medium transition-all hover:border-accent">
                ...
                <div className="space-y-6 mb-10">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      Urban Greens was using manual spreadsheets and Instagram
                      DMs to manage fresh produce orders, leading to lost sales
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                      A custom Shopify-powered storefront with an automated
                      inventory management system and local delivery zone
                      routing.
                    </p>
                  </div>
                </div>
        ...
        <div
          className="py-24 px-6 bg-slate-50 dark:bg-background-dark"
          id="contact"
        >
          <div className="max-w-7xl mx-auto">
